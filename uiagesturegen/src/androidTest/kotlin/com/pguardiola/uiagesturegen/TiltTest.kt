...
class TiltTest {
    ...
    @Test fun checksPreconditions() {
        ...
        try {
            ...
            val centerX = mapView.bounds.centerX()
            val centerY = mapView.bounds.centerY()
            // TODO Not working
            assertTrue(mapView.performTwoPointerGesture(
                    Point(centerX - 100, centerY), Point(centerX + 100, centerY),
                    Point(centerX - 100, centerY - 300), Point(centerX + 100, centerY - 300),
                    200))
